    ...
    <div v-else-if="artwork" class="row g-5">
      <div class="col-12 col-lg-7">
        ...
        <div class="mt-3 text-center text-muted small">
          ...
          Includes {{ artworkImages.length }} artwork photos and {{ certImages.length }} certificates.
        </div>
      </div>
      ...
      <div class="col-12 col-lg-5">
        <div class="h-100 d-flex flex-column">
          ...
          <div
            ...
            :class="artwork.aiVerified ? 'alert-success border-success' : 'alert-danger border-danger'"
            role="alert"
          >
          ...
          <div class="mt-auto d-grid gap-2 d-md-flex">
            ...
            >
              <span v-if="actionLoading === 'reject'" class="spinner-border spinner-border-sm me-2"></span>
            ...
            >
              <span v-if="actionLoading === 'approve'" class="spinner-border spinner-border-sm me-2"></span>
...
export default {
  ...
  computed: {
    artworkImages() {
      ...
      const gallery =
        this.artwork.artworkImages ||
        this.artwork.images ||
        this.artwork.gallery ||
        [];
    ...
    fetchArtwork() {
      ...
      axios
        ...
        .catch((err) => {
          console.error(err);
          this.error =
            err.response?.data?.message || "Failed to fetch artwork detail.";
        })
        .finally(() => {
        ...
        .catch((err) => {
          ...
          window.alert(
            err.response?.data?.message ||
              `Failed to ${action} the artwork. Please try again.`
          );
        })
        .finally(() => {
          this.actionLoading = "";
