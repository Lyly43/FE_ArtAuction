        ...
        <ul class="navbar-nav mx-auto gap-lg-4 gap-3">
          <li class="nav-item">
            <router-link
              ...
              to="/client/home"
              class="nav-link py-0"
              :class="{ active: $route.path === '/client/home' }"
              aria-current="page"
            >
              Home
            </router-link>
      ...
      <div class="d-flex align-items-center gap-4">
        ...
        <template v-if="user.check">
          ...
          <div class="dropdown">
            ...
            >
              <img
                src="/src/assets/img/icon-bell.png"
                class="icon-bell"
            ...
            >
              <div
                ...
                :key="notification.id"
                class="d-flex p-3 border-bottom w-100"
          ...
          <div class="d-flex gap-2 action-buttons">
            <div class="dropdown">
              ...
              <ul
                class="dropdown-menu dropdown-menu-end mt-2 p-3 border-2 border-success shadow overflow-hidden"
              >
                <li>
                ...
                <li>
                  <a
                    href="#"
                    class="dropdown-item d-flex align-items-center gap-3 py-2 px-4 mt-2 mb-1 text-danger"
    ...
    >
      <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
          ...
          <div class="modal-body">Bạn có chắc chắn muốn đăng xuất khỏi tài khoản hiện tại?</div>
